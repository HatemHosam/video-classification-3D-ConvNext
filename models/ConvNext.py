...
__all__ = ['convnext_xtiny', 'convnext_tiny', 'convnext_small', 'convnext_base', 'convnext_large', 'convnext_xlarge']
...
def convnext_xtiny(**kwargs):
    model = ConvNeXt(depths=[2, 2, 3, 2], dims=[96, 192, 384, 768], **kwargs)
    return model
